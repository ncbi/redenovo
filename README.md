...
```
- include a manual signature and rerun the tool with given set of signatures included (does not guarantee that given set will be kept, just force it to begin with those)
```bash
